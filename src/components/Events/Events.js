                  ...
                  <div className="columns">
                    <div className="column">
                      <label className="checkbox">
                        <input type="checkbox"></input>Arts & Music
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Service
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Cultural
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Business
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Civic Engagement
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Professional
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Interpersonal
                      </label>
                    </div>
                    <div className="column">
                      <label className="checkbox">
                        <input type="checkbox"></input>Social
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Spirituality
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Learning
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Interest Meeting
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Professional
                      </label>
                      <label className="checkbox">
                        <input type="checkbox"></input>Intercultural
                      </label>
                    </div>
                  </div>
