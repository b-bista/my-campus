                    ...
                    <div className="card-content">
                      <div className="media">
                        <div className="media-content">
                          ...
                          <p className="">
                            <small>
                              From: {eventProfile.events.from} To:{" "}
                              {eventProfile.events.to}{" "}
                            </small>
                          </p>
                          <p className="">
                            <small>
                              Address: {eventProfile.events.location}
                            </small>
                          </p>
                        </div>
                        ...
                        <div className="media-right">
                          <button className="button is-rounded is-small">
                            Going ({eventProfile.events.going.length})
                          </button>
                          <button className="button is-rounded is-small">
                            Interested ({eventProfile.events.going.length})
                          </button>
                        </div>
                      </div>
                      ...
                      <div style={{ padding: "10px 0 20px 0" }}>
                        <p className="post-content">
                          {eventProfile.events.description}
                        </p>
                      </div>
                      ...
                      {eventProfile.events.categories.map((item) => {
                        {
                          if (item.name) {
                            return (
                              <span className="button is-static is-rounded is-small">
                                {item.name}
                              </span>
                            );
                  ...
                  <div className="card is-paddingless">
                    <div className="card-content">
                      ...
                      <div style={{ padding: "20px 0 20px 0" }}>
                        ...
                        >
                          {eventProfile.events.hostedBy.name}
                        </p>
                        <div className="card-image">
                          <figure
                          ...
                          >
                            <img
                              ...
                              src={eventProfile.events.hostedBy.photo}
                            ></img>
                          </figure>
                        </div>
                      </div>
